        ...
        <div className="border rounded-xl p-5 bg-white">
          ...
          {submitted && (
            <div className="mb-4 rounded-lg border border-emerald-200 bg-emerald-50 p-4 text-sm text-emerald-800">
              ...
              <p><b>학년/반:</b> {form.grade
}학년 {form.classroom}반</p>
              <p><b>관심분야:</b> {form.interest
}</p>
              <p><b>목표:</b> {form.goal
}</p>
...
} onChange={e=>setForm(v=>({...v,name:e.target.value}))} placeholder="이름" className="border px-3 py-2 rounded-md" />
...
} onChange={e=>setForm(v=>({...v,grade:e.target.value}))} placeholder="학년(숫자)" className="border px-3 py-2 rounded-md" />
          ...
          <div className="mt-3">
            ...
            <p className="text-sm text-gray-600 mt-1">선택됨: {form.interest
 || '없음'}</p>
            {openInterests && (
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 mt-2">
                {[
                  ...
                  <button
                    ...
                    className={`border rounded-md px-3 py-2 text-sm ${form.interest
===f?'bg-emerald-600 text-white':'hover:bg-gray-50'}`}>
                    {f}
                  </button>
                ))}
              </div>
